...
public class DummyDevData implements CommandLineRunner {
    ...
    public void run(String... args) {
        AppUser admin = new AppUser("admin", "admin", "admin@lol.com", passwordEncoder.bCryptPasswordEncoder().encode("admin123"), "5146662222", "New york", "NY", "899 road", AppUserRoleEnum.ADMIN);
        ...
        admin.setDefaultSourceAddress(address1);
        appUserRepository.save(admin);
    }
}